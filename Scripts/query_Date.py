...
class testApp(CATBaseCase):
    ...
    def main(self):
        ...
        StepDesc(step_desc="2.判断TTS播报内容",expect_value="今天是202*年*月*号,星期*")
        while(True):
            if str(AT.FindElementBy_id(id="com.baidu.che.codriver:id/single_content",target="None",timeout="2000")) == "True":
                ...
                if len(temp) >= 15 and "今天是" in temp and "号" in temp and "星期" in temp and "当前网络异常" not in temp:
                    step2 = True
                    break
