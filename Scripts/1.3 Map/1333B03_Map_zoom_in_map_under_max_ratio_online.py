...
'''
  precondition: 当前地图已经处于放大到最大的状态，VA：放大地图，TTS，当前已为最大地图
'''
class testApp(CATBaseCase):
    ...
    def main(self):                # core steps
        ...
        AT.VRSpeak(string="",saveFile="Sources\\Medias\\Map\\Map_zoom_in_on_the_map.wav",volume="100",ensure="False")
