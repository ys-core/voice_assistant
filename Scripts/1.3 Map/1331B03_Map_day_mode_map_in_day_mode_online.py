...
'''
  precondition:当前已是白天模式，VA：白天模式，TTS，当前已是白天模式
'''
class testApp(CATBaseCase):
    ...
    def main(self):                # core steps
        ...
        AT.VRSpeak(string="",saveFile="Sources\\Medias\\Map\\Map_day_mode.wav",volume="100",ensure="False")
