...
class testApp(CATBaseCase):
    ...
    def setup(self):                # case的前置条件写在这里
        ...
        #4. 输入目的地
        # AT.GetElementBy_id(id="com.baidu.naviauto:id/et_ctrl_search",target="None",timeout="2000").Inputtext()
    ...
    def main(self):               # case的核心内容,比如每一步的动作等都写在这个函数里面
        ...
        AT.ClickElementBy_id(id="com.baidu.naviauto:id/tv_lion_search_search",target="None",timeout="2000")
